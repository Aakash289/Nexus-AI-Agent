...
Web orders live in Shopify. In-store transactions live in a POS system like Square, Lightspeed, or Revel. App activity lives in Firebase, Amplitude, or Mixpanel. Each system uses a different customer ID format. None of them share data with the others.
